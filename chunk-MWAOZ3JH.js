...
var OperatorSubscriber = class extends Subscriber {
  ...
  unsubscribe() {
    ...
    if (!this.shouldUnsubscribe || this.shouldUnsubscribe()) {
      ...
      super.unsubscribe();
      !closed && ((_a4 = this.onFinalize) === null || _a4 === void 0 ? void 0 : _a4.call(this));
    }
  }
};
...
function process(asyncIterable, subscriber) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    try {
      ...
      try {
        if (asyncIterable_1_1 && !asyncIterable_1_1.done && (_a4 = asyncIterable_1.return)) yield _a4.call(asyncIterable_1);
      } finally {
...
function createAndRenderEmbeddedLView(declarationLView, templateTNode, context2, options) {
  ...
  try {
    ...
    const embeddedLView = createLView(declarationLView, embeddedTView, context2, viewFlags, null, templateTNode, null, null, (_a4 = options == null ? void 0 : options.injector) != null ? _a4 : null, (_b2 = options == null ? void 0 : options.embeddedViewInjector) != null ? _b2 : null, (_c2 = options == null ? void 0 : options.dehydratedView) != null ? _c2 : null);
