...
} from "./chunk-OP3GFHB7.js";
import {
  createLockController
} from "./chunk-ZGYTMWGP.js";
import {
  findIonContent,
  getScrollElement,
...
import {
  transition
} from "./chunk-B5WYDVA2.js";
import {
  getTimeGivenProgression
} from "./chunk-2S57T3GS.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-IHK4FLNX.js";
import {
  createColorClasses,
  hostContext
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./chunk-5MVRJTNE.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./chunk-YMP4OYJO.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./chunk-SJBPHTJH.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./chunk-C43WIR4L.js");
        ...
        if (typeof window !== "undefined") {
          import("./chunk-ZAHKHIJX.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./chunk-RHMQ62UZ.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./chunk-PV36OZCH.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
